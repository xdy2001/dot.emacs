...
(defface moinmoin-anchor '((t (:foreground "tan3" :height 1.0)))
  "Face name to use for anchors (targets) in moinmoin"
  :group 'moinmoin)
(defface moinmoin-anchor-ref-id '((t (:foreground "blue2" :height 1.0 :underline t)))
...
(defface moinmoin-code '((t (:foreground "tomato2")))
...
(defface moinmoin-email '((t (:foreground "blue2")))
  ...
  :group 'moinmoin)
(defface moinmoin-url '((t (:foreground "blue2" :height 1.0)))
...
(defface moinmoin-stroke '((t (:strike-through t)))
  ...
  :group 'moinmoin)
(defface moinmoin-subscript '((t (:height 1.0)))
  "Face name to use for subscripts in moinmoin"
  :group 'moinmoin)
(defface moinmoin-superscript '((t (:height 1.0)))
